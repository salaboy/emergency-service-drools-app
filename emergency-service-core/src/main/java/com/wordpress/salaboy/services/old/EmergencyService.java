...
public class EmergencyService {
    ...
    private void setGlobals() {
        ...
        ksession.setGlobal("ambulances", CityEntities.ambulances);

        ksession.setGlobal("doctors", CityEntities.doctors);

        ksession.setGlobal("hospitals", CityEntities.hospitals);
