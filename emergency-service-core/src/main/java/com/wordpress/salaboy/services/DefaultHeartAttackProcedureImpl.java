 ...
 * @author salaboy
 */
public class DefaultHeartAttackProcedureImpl extends AbstractProcedureService implements DefaultHeartAttackProcedure {

    private String emergencyId;
    private String procedureId;

    public DefaultHeartAttackProcedureImpl() {
        super("com.wordpress.salaboy.bpmn2.DefaultHeartAttackProcedure");
    }
    ...
    public void configure(String emergencyId, Procedure procedure, Map<String, Object> parameters) {
        ...
        try {
            internalSession = createDefaultHeartAttackProcedureKnowledgeContext(this.emergencyId);
    ...
    private StatefulKnowledgeSession createDefaultHeartAttackProcedureKnowledgeContext(String emergencyId) throws IOException {
