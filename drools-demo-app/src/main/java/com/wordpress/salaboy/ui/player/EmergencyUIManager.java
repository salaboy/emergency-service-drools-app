...
//     private static void addEmergencySituation(GraphicableEmergency emergency, SpriteSheet sheet, float positionX, float positionY) {
//        
...
//    }
//     
//     public static GraphicableEmergency addEmergencyAlert(float positionX, float positionY){
//         GraphicableEmergency emergency = new GraphicableEmergency(new Emergency());
