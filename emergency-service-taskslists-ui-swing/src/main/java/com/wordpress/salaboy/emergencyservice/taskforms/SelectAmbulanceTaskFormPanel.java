 ...
 * @author esteban
 */
public class SelectAmbulanceTaskFormPanel extends javax.swing.JPanel {

    private SelectVehicleTaskListPanel parent;
    
    /** Creates new form AmbulancePanel */
    public SelectAmbulanceTaskFormPanel(SelectVehicleTaskListPanel parent) {
...
//                Logger.getLogger(SelectAmbulancePanel.class.getName()).log(Level.SEVERE, null, ex);
